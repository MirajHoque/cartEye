...
<div class="sidebar-widget  wow fadeInUp outer-top-vs ">
	<div id="advertisement" class="advertisement">
        <div class="item">
            <div class="avatar">
				<img src="{{ asset('frontend/assets/images/testimonials/member1.png') }}" alt="Image"></div>
		...
		<div class="clients_author">John Doe	<span>Abc Company</span>	</div><!-- /.container-fluid -->
         ...
         <div class="item">
         	<div class="avatar">
				<img src="{{ asset('frontend/assets/images/testimonials/member3.png') }}" alt="Image"></div>
		<div class="testimonials"><em>"</em>Vtae sodales aliq uam morbi non sem lacus port mollis. Nunc condime tum metus eud molest sed consectetuer.<em>"</em></div>
        ...
        @foreach ($multiImages as $image)
            <div class="single-product-gallery-item" id="slide{{ $image->id }}">
				...
				href="{{ asset($image->image_name) }}">
					...
					data-echo="{{ asset($image->image_name) }}" />
                </a>
				...
				@endforeach
					...
					<div class='col-sm-6 col-md-7 product-info-block'>
						<div class="product-info">
							...
							<h1 class="name">{{ $product->product_name_ban }}</h1>
							@else
